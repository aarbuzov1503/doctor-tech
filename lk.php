                ...
                <div class="desktop-menu-nav">
                    <nav class="header__nav nav">
                        <ul class="header__list list-reset">
                            ...
                            <li class="header__item"> 
                                <a class="header__link" href="check.php">Личный кабинет</a></li>
                        </ul>
                    </nav>
                </div>
            </div>
...
<div class="service-card flex-grid">
                    <img class="service-card__img" src="img/servises/bookmark.png" alt="Service 1">
                    <h3>Сервис хранения закладок</h3>
                    <p>500 ₽</p>
                    <a href="https://alex-verstak.ru/bookmap/index.html" target="blank">Посмотреть</a>
                </div>

                    <div class="service-card flex-grid">
                    <img class="service-card__img" src="img/servises/ya-go-scooter.png" alt="Service 1">
                    <h3>Яндекс GO</h3>
                    <p>2 000 ₽</p>
                    ...
                    <div class="service-card flex-grid">
                    <img class="service-card__img" src="img/servises/11.png" alt="Service 1">
                    <h3>Сайт визитка с ссылками (Активный)</h3>
                    <p>2 000</p>
                    <a href="https://munrozarasul.ru/" target="blank">Посмотреть</a>
                </div>
    
                    <div class="service-card flex-grid">
                            <img class="service-card__img" src="img/servises/10.png" alt="Service 1">
                            <h3>QR Генератор</h3>
                            <p>2 000 ₽</p>
                            <a href="https://alex-verstak.ru/qr.create/public_html/index.html" target="blank">Посмотреть</a>
                        </div>
                        
                          <div class="service-card flex-grid">
                            <img class="service-card__img" src="img/servises/10.png" alt="Service 1">
                            <h3>Агрегатор сервисов</h3>
                            <p>1 000 ₽</p>
                            <a href="https://alex-verstak.ru/agr/public_html/index.html" target="blank">Посмотреть</a>
                        </div>
                    
                    <div class="service-card flex-grid">
                            <img class="service-card__img" src="img/servises/9.png" alt="Service 1">
                            <h3>Сайт собирающий заявки</h3>
                            <p>3 000 ₽</p>
                            <a href="https://alex-verstak.ru/travel/index.html" target="blank">Посмотреть</a>
                        </div>
    
                        <div class="service-card flex-grid">
                            <img class="service-card__img" src="img/servises/8.png" alt="Service 2">
                            <h3>Картинная галерея</h3>
                            <p>2 000 ₽</p>
                            <a href="https://alex-verstak.ru/Gallery/index.html" target="blank">Посмотреть</a>
                        </div>
    
                        <div class="service-card flex-grid">
                            <img class="service-card__img" src="img/servises/7.png" alt="Service 2">
                            <h3>Путешествия</h3>
                            <p>5 000 ₽</p>
                            <a href="https://alex-verstak.ru/petersburg-travel/public_html/index.html" target="blank">Посмотреть</a>
                        </div>
    
                        <div class="service-card flex-grid">
                            <img class="service-card__img" src="img/servises/6.png" alt="Service 2">
                            <h3>Курсы Скиллбокс</h3>
                            <p>2 000 ₽</p>
                            <a href="https://alex-verstak.ru/skillbox/index.html" target="blank">Посмотреть</a>
                        </div>
    
                        <div class="service-card flex-grid">
                            <img class="service-card__img" src="img/servises/5.png" alt="Service 3">
                            <h3>Криптостикеры</h3>
                            <p>2 000 ₽</p>
                            <a href="#" target="blank">Посмотреть</a>
                        </div>
    
                        <div class="service-card flex-grid">
                            <img class="service-card__img" src="img/servises/4.png" alt="Service 3">
                            <h3>Сайт визитка</h3>
                            <p>2 000 ₽</p>
                            <a href="https://alex-verstak.ru/leanding-site/index.html" target="blank">Посмотреть</a>
                        </div>
    
                        <div class="service-card flex-grid">
                            <img class="service-card__img" src="img/servises/3.png" alt="Service 3">
                            <h3>Сайт отелей</h3>
                            <p>2 000 ₽</p>
                            <a href="https://alex-verstak.ru/Lagoona-new/index.html" target="blank">Посмотреть</a>
                        </div>
    
                        <div class="service-card flex-grid">
                            <img class="service-card__img" src="img/servises/2.png" alt="Service 3">
                            <h3>Проетные решения</h3>
                            <p>2 000 ₽</p>
                            <a href="https://alex-verstak.ru/evklug/public_html/index.html" target="blank">Посмотреть</a>
                        </div>
    
                        <div class="service-card flex-grid">
                            <img class="service-card__img" src="img/servises/1.png" alt="Service 3">
                            <h3>Отели</h3>
                            <p>2 500 ₽</p>
                            <a href="https://alex-verstak.ru/Lagoona-site/index.html" target="blank">Посмотреть</a>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <div class="container container-footer">
                <div class="footer__nav">
                    ...
                    <ul class="footer__list list-reset">
                        <li class="footer__list-item"><a aria-label="Перейти в телеграмм" class="footer__item"  href="https://t.me/a_arbuzov1503">Telegram</a></li>
                    </ul>
